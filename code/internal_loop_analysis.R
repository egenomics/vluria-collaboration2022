library(readr)
library(ggplot2)
internal_loop_lengths <- read_delim("/home/jlvillanueva/Documents/analysis/vluria_2022/results/internal_loop_lengths.txt","\t", escape_double = FALSE, trim_ws = TRUE)
...
inter_domains_loop_lengths <- read_delim("/home/jlvillanueva/Documents/analysis/vluria_2022/results/inter_domains_loop_lengths.txt",    "\t", escape_double = FALSE, trim_ws = TRUE)
...
summary_domains <- read_delim("/home/jlvillanueva/Documents/analysis/vluria_2022/results/summary_domains.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
mydata<-summary_domains %>% 
  group_by(age) %>% 
  summarize(n=n(), mean=mean(num_domains), prot_length=mean(protein_length), have_domain=sum(num_domains>=1))


write.table(mydata, "/home/jlvillanueva/Documents/analysis/vluria_2022/results/summary_domains_table.txt", sep="\t")
...
p1 <- p + geom_text(x = 10, y = 3500, label = lm_eqn(lm(protein_length ~ num_domains, summary_domains)), parse = TRUE)
p1
...
intra_domain_stretch_lengths <- read_delim("/home/jlvillanueva/Documents/analysis/vluria_2022/results/intra_domain_stretch_lengths.txt",    "\t", escape_double = FALSE, trim_ws = TRUE)
...
#Percentage#
############
intra_domain_stretch_composition <- read_delim("/home/jlvillanueva/Documents/analysis/vluria_2022/results/intra_domain_stretch_composition.txt",     "\t", escape_double = FALSE, trim_ws = TRUE)
...
#####################################
secondary_composition <- read_delim("/home/jlvillanueva/Documents/analysis/vluria_2022/results/all_proteins_composition.txt", "\t", escape_double = FALSE, col_names = TRUE, trim_ws = TRUE)
...
top20_word_count <- read_delim("/home/jlvillanueva/Documents/analysis/vluria_2022/results/top20_word_count.txt", " ", escape_double = FALSE, col_names = TRUE, trim_ws = TRUE)
...
'''
word_count_short <- read_delim("/home/josepl/Desktop/vluria/results//word_count_length_1_to_3.txt", "\t", escape_double = FALSE, col_names = TRUE, trim_ws = TRUE)
...
write.table(word_count_short, file = "/home/josepl/Desktop/vluria/results//short_words_table.txt", append = FALSE, quote = FALSE, sep = "\t",
